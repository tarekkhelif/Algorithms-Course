 ...
 * sites, named 0 through <em>n</em>–1. The <em>is-connected-to</em> relation
 ...
 * are identified with integers between 0 and <em>n</em>–1.  Initially, there
 * are <em>n</em> components, with each site in its own component. The
 * <em>component identifier</em> of a component (also known as the
 * <em>root</em>, <em>canonical element</em>, <em>leader</em>, or <em>set
 * representative</em>) is one of the sites in the component: two sites have the
 * same component identifier if and only if they are in the same component.
 * <ul>
 ...
 * itself changes during a call to <em>union</em>—it cannot change during a c
 * ll to <em>find</em>, <em>connected</em>, or <em>count</em>.
 * <p>
